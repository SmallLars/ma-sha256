...
Als spezifischer Hash-Algorithmus wird \glos{sha256} (siehe Kapitel \ref{chp:sha256}) verwendet. Dieser wird bei Bitcoin eingesetzt
...
Angriffe auf \glos{sha256} und Bitcoin durchzuführen.