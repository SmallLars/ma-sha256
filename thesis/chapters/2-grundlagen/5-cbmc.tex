...
\acr{cbmc} ist ein Model Checker für C und C++ Programme. Verwendung findet \acr{cbmc} in dieser Arbeit in der Evaluation in Kapitel \ref{chp:comparison}.
...
dass die Summe immer ungleich 42 sein muss. Das veranlasst \acr{cbmc} dazu, nach zwei Summanden zu suchen, die zusammen 42 ergeben. Gelingt dies, ist der
Beweis fehlgeschlagen und \acr{cbmc} gibt die gefundenen Summanden als Beispiel aus.
