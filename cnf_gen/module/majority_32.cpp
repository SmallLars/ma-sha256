...
unsigned Majority_32::stats[STATS_LENGTH];
...
Majority_32::Majority_32() : Modul(32, 3, 1) {
    output = 96;
}

Majority_32::~Majority_32() {
}

unsigned* Majority_32::getStats() {
    return stats;
}

void Majority_32::create(Collector* collector) {
    collector->newModul(10, "Majority_32", this);
