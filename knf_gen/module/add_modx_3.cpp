...
void Add_ModX_3::create(Collector* collector) {
    ...
    cc.printClause(10,      0,      CC_DC,          0,     CC_DC,             1,             1,         1,         CC_DC,             1,     CC_DC);
    cc.printClause(10,      0,      CC_DC,          1,     CC_DC,             1,             1,         1,         CC_DC,             0,     CC_DC);
    cc.printClause(10,      0,      CC_DC,          1,     CC_DC,             1,             0,         1,         CC_DC,             1,     CC_DC);
    cc.printClause(10,      0,      CC_DC,          0,     CC_DC,             1,             0,         1,         CC_DC,             0,     CC_DC);
    cc.printClause(10,      1,      CC_DC,          1,     CC_DC,             0,             1,         0,         CC_DC,             1,     CC_DC);
    cc.printClause(10,      1,      CC_DC,          0,     CC_DC,             0,             1,         0,         CC_DC,             0,     CC_DC);
    cc.printClause(10,      1,      CC_DC,          0,     CC_DC,             0,             0,         0,         CC_DC,             1,     CC_DC);
    cc.printClause(10,      1,      CC_DC,          1,     CC_DC,             0,             0,         0,         CC_DC,             0,     CC_DC);
