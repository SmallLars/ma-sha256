...
void Add_32::create(Collector* collector) {
    ...
    return;  // Below are useless because shorter clauses are already known.
    ...
    //XXX cc.printClause(8,        0,         0,      0,      CC_DC,     CC_DC,             0,     CC_DC,             0);
    ...
    for (unsigned i = 0; i < 30; i++) {
        ...
        //XXX cc.printClause(5,         1,             0,              0,             CC_DC,                 1);
        //XXX cc.printClause(5,         0,             1,              1,             CC_DC,                 1);
        //XXX cc.printClause(5,         1,             0,              0,                 1,             CC_DC);
        //XXX cc.printClause(5,         0,             1,              1,                 1,             CC_DC);
    }
    ...
    for (unsigned i = 0; i < 22; i++) {
        ...
        //XXX cc.printClause(8,             0,             1,              1,              1,          CC_DC,             CC_DC,              0,                 0);
        //XXX cc.printClause(8,             0,             1,              1,              1,              0,                 0,          CC_DC,             CC_DC);
        //XXX cc.printClause(8,             0,             1,              1,              1,              0,             CC_DC,          CC_DC,                 0);
        //XXX cc.printClause(8,             0,             1,              1,              1,          CC_DC,                 0,              0,             CC_DC);
    }
    ...
    for (unsigned i = 0; i < 30; i++) {
        ...
        //XXX cc.printClause(6,         1,          1,              0,              0,                 1,                 1);
    }
    ...
    for (unsigned i = 0; i < 29; i++) {
        ...
        //XXX cc.printClause(7,     CC_DC,             0,             1,          CC_DC,              1,                 0,                 1);
        //XXX cc.printClause(7,     CC_DC,             1,             0,              1,              0,                 1,                 1);
        //XXX cc.printClause(7,         0,         CC_DC,             1,              1,              1,                 0,                 1);
        //XXX cc.printClause(7,     CC_DC,             0,             1,          CC_DC,              1,                 1,                 0);
        //XXX cc.printClause(7,         0,         CC_DC,             1,              1,              1,                 1,                 0);
    }
    ...
    for (unsigned i = 0; i < 30; i++) {
        ...
        //XXX cc.printClause(5,         1,             0,         CC_DC,              0,              1);
        //XXX cc.printClause(5,         0,             1,         CC_DC,              1,              0);
        if (i == 29) break;
        //XXX cc.printClause(5,         1,             0,             1,              0,          CC_DC);
    }
    ...
    for (unsigned i = 0; i < 30; i++) {
        ...
        //XXX cc.printClause(6,         1,             0,              0,              1,                 0,             CC_DC);
        //XXX cc.printClause(6,         1,             0,              0,              1,             CC_DC,                 0);
    }
    ...
    for (unsigned i = 0; i < 29; i++) {
        ...
        //XXX cc.printClause(6,         0,             1,              1,              1,                 1,             CC_DC);
        //XXX cc.printClause(6,         0,             1,              1,              1,             CC_DC,                 1);
    }
    ...
    for (unsigned i = 0; i < 29; i++) {
        ...
        //XXX cc.printClause(6,         1,             0,          0,              0,                 1,             CC_DC);
        //XXX cc.printClause(6,         1,             0,          0,              0,             CC_DC,                 1);
    }
    ...
    for (unsigned i = 0; i < 30; i++) {
        ...
        //XXX cc.printClause(5,         0,             1,              1,             0,             0);
        //XXX cc.printClause(5,         1,             0,              0,             1,             1);
    }
    ...
    for (unsigned i = 0; i < 30; i++) {
        ...
        //XXX cc.printClause(6,         0,             1,          1,              1,             0,         CC_DC);
        //XXX cc.printClause(6,         0,             1,          1,              1,         CC_DC,             0);
    }
    ...
    for (unsigned i = 0; i < 29; i++) {
        ...
        //XXX cc.printClause(5,         0,             1,              1,              1,              0);
    }
    ...
    for (unsigned i = 0; i < 29; i++) {
        ...
        //             c_out[0]       c_out[1]       c_out[2]        s_out[1]        s_out[2]
        cc.setLiterals(5, start + i, start + 1 + i, start + 2 + i, output + 1 + i, output + 2 + i);
        //XXX cc.printClause(5,         0,             0,             1,              1,              1);
    }
#endif
}
