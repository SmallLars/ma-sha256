...
void Des_SBox_7::create(Collector* collector) {
    collector->newModul(0, "Des_SBox_7", this);
...
MU_TEST_C(Des_SBox_7::test) {
    ...
    unsigned out[]  = {0x04, 0x0d, 0x0b, 0x00, 0x02, 0x0b, 0x0e, 0x07,
    ...
    for (unsigned t = 0; t < 64; t++) {
        ...
        mu_assert(out[t] == solver_readInt_msb(solver, 6, 4), "DES_SBOX_7 failed");
    }
}
