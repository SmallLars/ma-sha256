...
void Des_SBox_6::create(Collector* collector) {
    collector->newModul(0, "Des_SBox_6", this);
...
MU_TEST_C(Des_SBox_6::test) {
    ...
    unsigned out[]  = {0x0c, 0x0a, 0x01, 0x0f, 0x0a, 0x04, 0x0f, 0x02,
    ...
    for (unsigned t = 0; t < 64; t++) {
        ...
        mu_assert(out[t] == solver_readInt_msb(solver, 6, 4), "DES_SBOX_6 failed");
    }
}
