...
void Add_Half_2::create(Collector* collector) {
    collector->newModul(1, "Add_Half_2", this);
    ...
    cc.printClause(7, CC_DC,  CC_DC,          0,         1,             1,     CC_DC,             1);
    cc.printClause(7, CC_DC,  CC_DC,          1,         1,             0,     CC_DC,             1);
    cc.printClause(7, CC_DC,  CC_DC,          0,         1,             0,     CC_DC,             0);
    ...
    cc.printClause(7, CC_DC,  CC_DC,          1,     CC_DC,             0,         1,             1);
    ...
    cc.printClause(7, CC_DC,      1,          1,         0,             1,     CC_DC,             1);
    cc.printClause(7, CC_DC,      1,          0,         0,             1,     CC_DC,             0);
    cc.printClause(7, CC_DC,      1,          1,         0,             0,     CC_DC,             0);
    cc.printClause(7, CC_DC,      1,          1,     CC_DC,             1,         0,             1);
    cc.printClause(7, CC_DC,      1,          0,     CC_DC,             1,         0,             0);
    cc.printClause(7, CC_DC,      1,          1,     CC_DC,             0,         0,             0);
